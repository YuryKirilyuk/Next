...
<?php if ( 'on' === et_get_option( 'divi_show_linkedin_icon', 'on' ) ) : ?>
    <li class="et-social-icon et-social-linkedin">
        <a target="_blank" href="<?php echo esc_url( et_get_option( 'divi_linkedin_url', 'https://www.linkedin.com/company/gbef-government-business-executive-forum/?viewAsMember=true' ) ); ?>" class="icon">
